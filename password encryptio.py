...
lst=iml2
n=len(lst)
img=im.open("C:\\Users\\LENOVO\\OneDrive\\Desktop\\Hash.jpg")
...
if op==2:
    ...
    #plt.savefig('C:\\Users\\LENOVO\\OneDrive\\Desktop\\crypto\\img1.png')
    plt.close()
    np.uint8(array)
    
    imageio.imwrite("C:\\Users\\LENOVO\\OneDrive\\Desktop\\Crypto\\"+acc+".jpg",array)
    ...
    np.uint8(array)
    imageio.imwrite("C:\\Users\\LENOVO\\OneDrive\\Desktop\\verify\\"+acc+".jpg",array)
    ans=im.open("C:\\Users\\LENOVO\\OneDrive\\Desktop\\crypto\\"+acc+".jpg")
    img1=im.open("C:\\Users\\LENOVO\\OneDrive\\Desktop\\verify\\"+acc+".jpg")
    print()
    print()
    print("******************************************************************************************")
